...
void o.fetch(r("#isso-thread").getAttribute("data-isso-id"),t["max-comments-top"],t["max-comments-nested"]).then(function(e){
   ...
   //     }) 
    for (var i = 4; i >= 0; i--) {
       var item = e.replies[i];
       a.insert(item,!1);
       item.created>t&&(t=item.created);
       o+=item.total_replies;
    }
    ...
    },function(e){console.log(e)}))})}),define("embed",function(){})}();
