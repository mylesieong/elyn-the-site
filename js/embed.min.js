    ...
    ! function(e) {
        ...
        function(e) {
            ...
            var m = function(i) {
                    ...
                    return m.onsuccess = function() {}, m.validate = function() {
                        ...
                        if (m.validate()) {
                            ...
                            s.setItem("author", JSON.stringify(n)), s.setItem("email", JSON.stringify(a)), s.setItem("website", JSON.stringify(r)), o.create(e("#isso-thread").getAttribute("data-isso-id"), {
                                ...
                                e(".textarea", m).innerHTML = "", e(".textarea", m).blur();
				/* Myles' change: insert to top */
				d(t, 0, !0);
				null !== i && m.onsuccess()
                            })
                        }
                ...
                c = function(t, i) {
                    /* This is isso.insert_loader function */
                    var r;
                    ...
                    r.append(s), e("a.load_hidden", s).on("click", function() {
                        s.remove(), 
                        /* Below the api.fetch call */
                        o.fetch(e("#isso-thread").getAttribute("data-isso-id"), -1, n["max-comments-nested"]).then(
                            function(rv) {
                                if (0 !== rv.total_replies) {
                                    /* Clear content */
                                    e("#isso-root").textContent = "",
                                    rv.replies.forEach(function(e) {
                                        d(e, !1)
                                    })
                                }
                            }, function(e) {
                ...
                d = function(l, u, insertToTop=false) {
                    ...
                    var h;
                    h = e(null === l.parent ? "#isso-root" : "#isso-" + l.parent + " > .text-wrapper > .isso-follow-up");

		    if (insertToTop) {
		    	console.log("Myles-insert to top with prepend.");
		        h.prepend(p);
		    } else {
		    	console.log("Myles-insert with append.");
		        h.append(p);
		    }
            ...
            c.set("conf", t), c.set("i18n", n.translate), c.set("pluralize", n.pluralize), c.set("svg", m), e(function() {
                ...
                return i(), null === r("#isso-thread") ? console.log("abort, #isso-thread is missing") : (r("#isso-thread").append(r["new"]("h4")), r("#isso-thread").append(new a.Postbox(null)), r("#isso-thread").append('<div id="isso-root"></div>'), void o.fetch(r("#isso-thread").getAttribute("data-isso-id"), t["max-comments-top"], t["max-comments-nested"]).then(function(e) {
                    /* Begin of internet request callback */
                    if (0 === e.total_replies) 
                        return void(r("#isso-thread > h4").textContent = n.translate("no-comments"));
                    ...
                    e.replies.forEach(function(e) {
                        a.insert(e, !1), 
                        e.created > t && (t = e.created), 
                        o += e.total_replies
                    }), 
                    
                    r("#isso-thread > h4").textContent = n.pluralize("num-comments", o),
                    e.hidden_replies > 0 && a.insert_loader(e, t),
                    window.location.hash.length > 0 && r(window.location.hash).scrollIntoView()

                    /* Myles fix r("#isso-root").textContent = ""; */
